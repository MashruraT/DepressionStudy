    ...
    private void init() {
        btnEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent upanel = new Intent(Lobby.this, ProfileActivity.class);
        ...
        btnRecord.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Lobby.this,RecordSample1.class);
...
//                intent.putExtra("Self_name", person.name);
        ...
        btnChangePass.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(Lobby.this);
